...
const WorkspaceViewDetails: React.FC = () => {
    const navigate = useNavigate();

    // Example workspace data; in a real scenario, you'd fetch this data from your API or state
    const workspace = {
            ...
            <div className="flex-1 p-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <div className="flex items-center mb-4">
                        <img src={"https://picsum.photos/id/237/200/300"} alt="Workspace Logo" className="w-24 h-24 rounded-full object-cover mr-4" />
...
export default WorkspaceViewDetails;
